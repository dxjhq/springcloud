...
import com.hhly.utils.encrypt.jwt.JWTSigner;
import com.hhly.utils.encrypt.jwt.JWTVerifyException;
import com.hhly.utils.encrypt.jwt.JWTExpiredException;
import com.hhly.utils.encrypt.jwt.JWTVerifier;
...
public final class Encrypt {
    ...
    public static String aesEncode(String data) {
        ...
        try {
            ...
            throw new EncryptException(ALGORITHM + "(" + data + ")加密失败");
        }
    }
    ...
    public static String aesDecode(String data) {
        ...
        try {
            ...
            throw new EncryptException(ALGORITHM + "(" + data + ")解密时异常");
        }
    }
    ...
    private static String toHash(String src, String method) {
        try {
            ...
            throw new EncryptException("无法给(" + src + ")生成(" + method + ")摘要");
        }
    }

    public static void main(String[] args) {
        String key = "123456";
        System.out.println(toMd5(key));
        String encode = aesEncode(key);  //4737e8713a7c491e4ea60efde9acea29
        System.out.println("encode:"+encode);
        System.out.println("decode:"+aesDecode(encode));
        System.out.println("32_md5:"+toMd5(key));
    }
}
