...
/*
    ...
    public void addConfigurationProperties(Properties properties) {
        ...
        String dateFormatString = "yyyy-MM-dd";//properties.getProperty(PropertyRegistry.COMMENT_GENERATOR_DATE_FORMAT);
...
/*        StringBuilder sb = new StringBuilder();
        ...
        boolean isSupportLombok = JavaBeansUtil.isSupportLombokEnabled(introspectedTable);
        if(isSupportLombok){
       ...
       // method.setFinal(addMethodFinal);
        ...
        for (Parameter parameter : parameterList) {
            ...
            if ("orderByClause".equals(paramterName)) {
                ...
                } else if ("selectSelective".equals(method_name) ){
                    sb.append(" 根据对象属性值进行查找");
                }
