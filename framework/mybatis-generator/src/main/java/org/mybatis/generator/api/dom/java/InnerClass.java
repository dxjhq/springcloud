...
public class InnerClass extends JavaElement {
    ...
    public String getFormattedContent(int indentLevel, CompilationUnit compilationUnit) {
        ...
        if (superClass != null) {
            ...
            String supperClzShortName = JavaDomUtils.calculateTypeName(compilationUnit, superClass);
            int index = supperClzShortName.lastIndexOf(".");
            if(index > 0){
                supperClzShortName = supperClzShortName.substring(index+1);
            }
            sb.append(supperClzShortName);
        }
