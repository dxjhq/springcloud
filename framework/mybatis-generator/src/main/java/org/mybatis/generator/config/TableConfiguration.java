...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean selectSelectiveEnabled;
    ...
    /** the select by selective query id**/
    private String selectSelective;
    ...
    public XmlElement toXmlElement() {
        ...
        if (!insertSelectiveStatementEnabled) {
            xmlElement.addAttribute(new Attribute("enableInsertSelective", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        if (!updateByPrimaryKeySelectiveStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableUpdateByPrimaryKeySelective", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        if (stringHasValue(selectSelective)) {
            xmlElement.addAttribute(new Attribute(
                    "selectSelective", selectSelective)); //$NON-NLS-1$
        }
    ...
    public boolean isSelectSelectiveEnabled() {
        return selectSelectiveEnabled;
    }

    public void setSelectSelectiveEnabled(boolean selectSelectiveEnabled) {
        this.selectSelectiveEnabled = selectSelectiveEnabled;
    }

    public String getSelectSelective() {
        return selectSelective;
    }

    public void setSelectSelective(String selectSelective) {
