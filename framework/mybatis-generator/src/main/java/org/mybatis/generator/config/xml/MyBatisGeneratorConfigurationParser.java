...
public class MyBatisGeneratorConfigurationParser {
    ...
    protected void parseTable(Context context, Node node) {
        ...
        String enableUpdateByPrimaryKeySelective = attributes.getProperty("enableUpdateByPrimaryKeySelective"); //$NON-NLS-1$
        ...
        if (stringHasValue(enableSelectSelective)) {
            tc.setSelectSelectiveEnabled(isTrue(enableSelectSelective));
        }
